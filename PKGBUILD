...
conflicts=('firefox')
source=(https://archive.mozilla.org/pub/firefox/releases/95.0.1/linux-x86_64/en-US/firefox-95.0.1.tar.bz2
        $_pkgname.sh
        $_pkgname.desktop)
sha256sums=('3ec59f8af04ca4d7f5a4a4a09efd692c274e91d1ab2f7b14ff609c4a801e78f2'
